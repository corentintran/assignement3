...
namespace CAB301_Assignment3
{
    class AppTest
    {
        static void Main(string[] args)
        {
            ...
            //Tests
            Globals.allMovies.Insert(new Movie("Superman Returns", MovieGenre.Action, MovieClassification.M, 120, 1));
            Globals.allMovies.Insert(new Movie("Joker", MovieGenre.Drama, MovieClassification.M15Plus, 122, 7));
            Globals.allMovies.Insert(new Movie("Once Upon a Time... In Hollywood", MovieGenre.Drama, MovieClassification.M15Plus, 161, 9));
            Globals.allMovies.Insert(new Movie("Marriage Story", MovieGenre.Drama, MovieClassification.M15Plus, 137, 1));

            IMember testMember1 = new Member("test2", "test2", "0123456789", "1234");
            IMember testMember2 = new Member("test3", "test3", "0123456789", "1234");
            Globals.allMembers.Add(testMember1);
            Globals.allMembers.Add(testMember2);

            IMovie joker = Globals.allMovies.Search("Joker");
            testMember2.Borrowings.Insert(joker);
            joker.AddBorrower(testMember2);
